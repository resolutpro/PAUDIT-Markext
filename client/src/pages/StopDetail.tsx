...
export default function StopDetail() {
  ...
  const { preferEasyRead, setPreferEasyRead, enableSubtitles } =
    useAccessibility();
      ...
      >
        ...
        <section aria-labelledby="stop-title">
          ...
          <div
            ...
            aria-live="polite"
          >
            {/* Si preferEasyRead es true Y el json tiene easyReadText, muestra Lectura Fácil. Si no, muestra el normal */}
            {preferEasyRead && stop.easyReadText ? (
              <p>{stop.easyReadText}</p>
            ) : (
              <p>{stop.text}</p>
            )}
          </div>
