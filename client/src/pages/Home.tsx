...
export default function Home() {
  ...
  return (
    <main id="main-content" className="pb-8 animate-in fade-in duration-500">
      {/* Hero Section */}
      <section className="relative h-[300px] md:h-[400px] w-full overflow-hidden rounded-b-3xl md:rounded-3xl md:mt-4 md:w-[calc(100%-2rem)] md:max-w-6xl md:mx-auto mb-8">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center p-6 text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-white mb-2 max-w-2xl leading-tight text-shadow">
            Explora el Patrimonio Cultural de Jerez de los Caballeros
          </h1>
      ...
      <div className="container px-4 max-w-6xl mx-auto space-y-8">
        ...
        <section aria-labelledby="featured-routes-title">
          <div className="flex items-center justify-between mb-6">
            <h2 id="featured-routes-title" className="text-2xl font-bold">
              Rutas Destacadas
            </h2>
            <Link
              href="/rutas"
        ...
        <section className="bg-secondary/50 rounded-2xl p-6 border border-border/50 mt-8 flex flex-col sm:flex-row items-center gap-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Todas nuestras rutas están diseñadas siguiendo las directrices
              WCAG AA. Incluyen audioguías con transcripción, vídeos en LSE y
              textos adaptables a tus preferencias.
            </p>
          </div>
